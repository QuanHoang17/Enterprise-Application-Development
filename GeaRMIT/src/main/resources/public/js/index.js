...
const bestSellerText = document.querySelector('.section-title');
let d = new Date();
...
bestSellerText.textContent = 'Best-sellers in ' + monthNames[month];
console.log(bestSellerText.textContent);
